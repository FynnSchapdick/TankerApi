...
namespace Tankerkoenig.NetStandard
{
    public class TankerKoenig
        {
            ...
            public async Task<TResponse> GetStationsAsync<TResponse>(IRequest<TResponse> request, CancellationToken cancellationToken = default)
            {
